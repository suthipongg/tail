...
and may be edited to test the various functions found in Bravo 5 class.
Further specifics of use are documented in that section.

Functions requiring a "deviceID" argument (e.g. get_position(deviceID)):
Bravo 5.deviceIDs[0] refers to the grabber,
Bravo 5.deviceIDs[1] refers to the rotate joint used to rotate the grabber,
Bravo 5.deviceIDs[4] refers to the main I/O device on the Bravo 5.
...
class Bravo5():
    """Bravo5 Class: Example class used for interfacing with the Bravo 5 attached on the serial port (COM_PORT)
    ...
    deviceIDs = [0x01, 0x02, 0x03, 0x04, 0x05, 0x0D, 0x0E]
    # base_device_id = 0x0E
    ...
    def set_position(self, device_id, position):
        ...
        print('Bravo 5 sent position for device', device_id, ':', position)
    ...
    def set_velocity(self, device_id, velocity):
        ...
        print('Bravo 5 sent velocity for device', device_id, ':', velocity)
    ...
    def set_openloop(self, device_id, openloop):
        ...
        print('Bravo 5 sent openloop for device', device_id, ':', openloop) 
    ...
    def set_current(self, device_id, current):
        ...
        print('Bravo 5 sent current for device', device_id, ':', current) 
    ...
    def set_mode(self, device_id, mode):
        ...
        print('Bravo 5 sent mode for device', device_id, ':', mode)
...
if __name__ == '__main__':
    '''MAIN function/
    The following sequence provides an example of how to use the Bravo 5 class.
    It may be edited to allow for experimentation with the unit.
    '''
    # Setup Bravo 5 and connect to serial port
    rs = Bravo5()           # create an instance of the Bravo 5 class
